<#import "temp/main.ftl" as main/>
<form action="${webRoot}/schedule.html" method="get" accept-charset="utf-8">
    <input type="hidden" name="termName" value="${term}" required>
    <div class="form-group">
        <label>班级</label>
        <select name="class" class="selectpicker form-control" required="required" data-live-search="true"
                title="请选择班级">
    ...
    <div class="form-group">
        ...
        <select name="ignoreType" class="selectpicker form-control select-less-item" multiple="multiple" title="选择以忽略……">
